...
const AdminOverview = () => {
  ...
  const draftPools = allPools.filter((p: any) => p.status === "draft").length;
  ...
  return (
    <div className="p-4 md:p-8 space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard icon={BarChart3} title="Pool Templates" value={String(draftPools)} change="Draft opportunities" changeType="neutral" />
